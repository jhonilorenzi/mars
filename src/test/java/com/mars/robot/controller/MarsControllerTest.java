package com.mars.robot.controller;

import com.mars.robot.ControllerBaseTest;
...
public class MarsControllerTest extends ControllerBaseTest {
    ...
    private static final String COMMAND_PATH_VARIABLE = "Commands valid are L (left), R (right) and M (move)";
